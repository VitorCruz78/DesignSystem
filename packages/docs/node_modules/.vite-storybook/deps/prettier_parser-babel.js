...
`);
        ...
        var Ui = /* @__PURE__ */ new Set([103, 109, 115, 105, 121, 117, 100, 118]), O = class {
          ...
          unexpected(t, e) {
            throw this.raise(p.UnexpectedToken, { expected: e ? H(e) : null, at: t != null ? t : this.state.startLoc });
          }
          expectPlugin(t, e) {
            if (this.hasPlugin(t))
              return true;
          ...
          flowParseObjectType({ allowStatic: e, allowExact: s, allowSpread: i, allowProto: r, allowInexact: n }) {
            ...
            for (s && this.match(6) ? (this.expect(6), l = 9, c = true) : (this.expect(5), l = 8, c = false), h.exact = c; !this.match(l); ) {
              ...
              if (this.eat(0))
                ...
                let we = this.flowParseObjectTypeProperty(C, d, y, E, k, i, n != null ? n : !c);
...
`);
      ...
      function Se(a) {
        ...
        return Ae = Se.prototype = a != null ? a : /* @__PURE__ */ Object.create(null), new Se();
      }
      var Hr = 10;
      for (let a = 0; a <= Hr; a++)
        Se();
      ...
      function ia({ isExpression: a = false, optionsCombinations: t }) {
        return (e, s = {}) => {
          ...
          let i = t;
          ((_a = s.__babelSourceType) != null ? _a : Ms(s)) === "script" && (i = i.map((l) => ({ ...l, sourceType: "script" }))), /#[[{]/.test(e) && (i = i.map((l) => R([Zr], l)));
          let n = /%[A-Z]/.test(e);
